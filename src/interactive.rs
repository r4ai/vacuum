...
static KEYBINDINGS: &[KeyBinding] = &[
    ...
    KeyBinding {
        key: "Ctrl+u",
        desc: "Half page up",
        action: Action::MoveHalfPageUp,
    },
    KeyBinding {
        key: "Ctrl+d",
        desc: "Half page down",
        action: Action::MoveHalfPageDown,
    },
    KeyBinding {
        key: "g / Home",
        desc: "Jump to top",
    ...
    KeyBinding {
        key: "e",
        desc: "Show full details of cursor row",
        action: Action::OpenDetail,
    },
    KeyBinding {
        key: "1",
        desc: "Sort by Adapter",
        action: Action::SortByAdapter,
    },
    KeyBinding {
        key: "2",
        desc: "Sort by Path",
        action: Action::SortByPath,
    },
    KeyBinding {
        key: "3",
        desc: "Sort by Size",
    ...
    KeyBinding {
        ...
        action: Action::SortByDescription,
    },
    KeyBinding {
        key: "/",
        desc: "Filter items",
    ...
    KeyBinding {
        key: "Enter",
        desc: "Confirm and delete",
        action: Action::Confirm,
    },
    KeyBinding {
        key: "q / Esc",
        desc: "Quit without deleting",
        action: Action::Quit,
    },
];
